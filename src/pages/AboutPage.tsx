        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-12 md:mb-16 px-2 sm:px-0">
            {stats.map((stat, index) => (
              ...
              >
                <Card className="p-4 sm:p-6 text-center bg-black/60 backdrop-blur-sm border border-white/10 shadow-2xl hover:shadow-3xl hover:bg-black/70 transform hover:-translate-y-2 transition-all duration-500 hover:scale-105 w-full">
                  <stat.icon className="h-8 w-8 sm:h-10 sm:w-10 text-green-400 mx-auto mb-2 sm:mb-3 group-hover:text-green-300 transition-colors duration-300" />
                  <div className="text-2xl sm:text-3xl font-bold text-white mb-1 sm:mb-2 group-hover:text-green-100 transition-colors duration-300">
                    {stat.value}
                  </div>
                  <div className="text-xs sm:text-sm font-medium text-gray-200 group-hover:text-gray-100 transition-colors duration-300 leading-tight">
                    {stat.label}
                  </div>
                </Card>
              </motion.div>

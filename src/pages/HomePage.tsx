...
import logoUrl from '../assets/barudaks.svg';
  ...
  >
    ...
    >
      <button
        ...
        className="group relative px-6 md:px-8 py-3 md:py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-base md:text-lg rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 overflow-hidden"
      >
      ...
      <button
        ...
        data-scroll-to-top="true"
        className="group px-6 md:px-8 py-3 md:py-4 border-2 border-white/80 hover:border-white text-white hover:bg-white/10 font-bold text-base md:text-lg rounded-xl backdrop-blur-sm transform hover:scale-105 transition-all duration-300"
      >
        Tentang Desa
      </button>
    </motion.div>
